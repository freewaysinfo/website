        ...
        <Section>
          <Container className="max-w-4xl">
            ...
            <div className="space-y-8 text-(--brand-gray)]">
              ...
              <section>
                <h2 className="text-xl font-bold text-(--brand-dark)] mb-4">2. Hosting und Content Delivery Networks (CDN)</h2>
                <p>Wir hosten unsere Website bei Vercel. Anbieter ist die Vercel Inc., 440 N Barranca Ave #4133 Covina, CA 91723, USA.</p>
              </section>

              <section>
                <h2 className="text-xl font-bold text-(--brand-dark)] mb-4">3. Allgemeine Hinweise und Pflichtinformationen</h2>
                <p>
              ...
              <section>
                <h2 className="text-xl font-bold text-(--brand-dark)] mb-4">4. Datenerfassung auf dieser Website</h2>
                <h3 className="font-bold mb-2 text-(--brand-dark)]">Kontaktformular / E-Mail / Telefon</h3>
                <p>
              ...
              <section>
                <h2 className="text-xl font-bold text-(--brand-dark)] mb-4">5. Ihre Rechte</h2>
                <p>
