            ...
            <div className="space-y-8 text-white/70">
              ...
              <div>
                ...
                <p>
                  ...
                  <a href="https://ec.europa.eu/consumers/odr/" className="text-(--brand-green) hover:underline" target="_blank" rel="noopener noreferrer"> https://ec.europa.eu/consumers/odr/</a>.<br />
